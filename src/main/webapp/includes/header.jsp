...
<!-- Product view slider -->
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/jquery.simpleLens.css">
<!-- slick slider -->
...
<!-- Top Slider CSS -->
<link href="${pageContext.request.contextPath}/css/sequence-theme.modern-slide-in.css" rel="stylesheet" media="all">
